...
const Schema: z.ZodType<Prisma.UserCreateNestedManyWithoutSavedWorkoutsInput> =
  z
    .object({
      create: z
        .union([
...
export const UserCreateNestedManyWithoutSavedWorkoutsInputObjectSchema = Schema;
