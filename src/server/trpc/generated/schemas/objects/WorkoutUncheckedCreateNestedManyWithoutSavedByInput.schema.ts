...
const Schema: z.ZodType<Prisma.WorkoutUncheckedCreateNestedManyWithoutSavedByInput> =
  z
    .object({
      create: z
        .union([
...
export const WorkoutUncheckedCreateNestedManyWithoutSavedByInputObjectSchema =
  Schema;
