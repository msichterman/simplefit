...
const Schema: z.ZodType<Prisma.WorkoutUncheckedCreateNestedManyWithoutExercisesInput> =
  z
    .object({
      create: z
        .union([
...
export const WorkoutUncheckedCreateNestedManyWithoutExercisesInputObjectSchema =
  Schema;
