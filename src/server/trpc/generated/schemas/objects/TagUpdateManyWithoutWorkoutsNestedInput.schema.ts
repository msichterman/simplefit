...
const Schema: z.ZodType<Prisma.TagUpdateManyWithoutWorkoutsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => TagUpsertWithWhereUniqueWithoutWorkoutsInputObjectSchema),
        z
          .lazy(() => TagUpsertWithWhereUniqueWithoutWorkoutsInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => TagUpdateWithWhereUniqueWithoutWorkoutsInputObjectSchema),
        z
          .lazy(() => TagUpdateWithWhereUniqueWithoutWorkoutsInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const TagUpdateManyWithoutWorkoutsNestedInputObjectSchema = Schema;
