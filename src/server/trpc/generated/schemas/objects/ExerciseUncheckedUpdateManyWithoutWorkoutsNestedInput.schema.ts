...
const Schema: z.ZodType<Prisma.ExerciseUncheckedUpdateManyWithoutWorkoutsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ExerciseUncheckedUpdateManyWithoutWorkoutsNestedInputObjectSchema =
  Schema;
