...
const Schema: z.ZodType<Prisma.WorkoutUpdateManyWithoutTagsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => WorkoutUpsertWithWhereUniqueWithoutTagsInputObjectSchema),
        z
          .lazy(() => WorkoutUpsertWithWhereUniqueWithoutTagsInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => WorkoutUpdateWithWhereUniqueWithoutTagsInputObjectSchema),
        z
          .lazy(() => WorkoutUpdateWithWhereUniqueWithoutTagsInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const WorkoutUpdateManyWithoutTagsNestedInputObjectSchema = Schema;
