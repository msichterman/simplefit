...
const Schema: z.ZodType<Prisma.TagUncheckedCreateNestedManyWithoutWorkoutsInput> =
  z
    .object({
      create: z
        .union([
...
export const TagUncheckedCreateNestedManyWithoutWorkoutsInputObjectSchema =
  Schema;
