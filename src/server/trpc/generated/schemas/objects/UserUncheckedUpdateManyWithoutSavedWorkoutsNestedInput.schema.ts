...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutSavedWorkoutsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedUpdateManyWithoutSavedWorkoutsNestedInputObjectSchema =
  Schema;
