...
const Schema: z.ZodType<Prisma.WorkoutUncheckedCreateNestedManyWithoutAuthorInput> =
  z
    .object({
      create: z
        .union([
...
export const WorkoutUncheckedCreateNestedManyWithoutAuthorInputObjectSchema =
  Schema;
