...
const Schema: z.ZodType<Prisma.TagUncheckedUpdateManyWithoutExercisesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => TagUpsertWithWhereUniqueWithoutExercisesInputObjectSchema
          ),
          z
            .lazy(
              () => TagUpsertWithWhereUniqueWithoutExercisesInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => TagUpdateWithWhereUniqueWithoutExercisesInputObjectSchema
          ),
          z
            .lazy(
              () => TagUpdateWithWhereUniqueWithoutExercisesInputObjectSchema
...
export const TagUncheckedUpdateManyWithoutExercisesNestedInputObjectSchema =
  Schema;
