...
const Schema: z.ZodType<Prisma.ExerciseUncheckedCreateNestedManyWithoutWorkoutsInput> =
  z
    .object({
      create: z
        .union([
...
export const ExerciseUncheckedCreateNestedManyWithoutWorkoutsInputObjectSchema =
  Schema;
