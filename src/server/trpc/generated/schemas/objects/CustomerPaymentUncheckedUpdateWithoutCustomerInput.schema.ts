...
const Schema: z.ZodType<Prisma.CustomerPaymentUncheckedUpdateWithoutCustomerInput> =
  z
    .object({
      id: z
        .union([
...
export const CustomerPaymentUncheckedUpdateWithoutCustomerInputObjectSchema =
  Schema;
