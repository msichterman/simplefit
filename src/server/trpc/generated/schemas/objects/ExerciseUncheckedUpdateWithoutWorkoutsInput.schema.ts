...
const Schema: z.ZodType<Prisma.ExerciseUncheckedUpdateWithoutWorkoutsInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const ExerciseUncheckedUpdateWithoutWorkoutsInputObjectSchema = Schema;
