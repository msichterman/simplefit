...
const Schema: z.ZodType<Prisma.WorkoutUncheckedUpdateManyWithoutExercisesNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const WorkoutUncheckedUpdateManyWithoutExercisesNestedInputObjectSchema =
  Schema;
