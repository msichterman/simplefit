...
const Schema: z.ZodType<Prisma.ExerciseUpdateManyWithoutTagsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => ExerciseUpsertWithWhereUniqueWithoutTagsInputObjectSchema),
        z
          .lazy(() => ExerciseUpsertWithWhereUniqueWithoutTagsInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => ExerciseUpdateWithWhereUniqueWithoutTagsInputObjectSchema),
        z
          .lazy(() => ExerciseUpdateWithWhereUniqueWithoutTagsInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const ExerciseUpdateManyWithoutTagsNestedInputObjectSchema = Schema;
