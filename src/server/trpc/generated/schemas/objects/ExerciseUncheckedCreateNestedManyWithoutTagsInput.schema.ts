...
const Schema: z.ZodType<Prisma.ExerciseUncheckedCreateNestedManyWithoutTagsInput> =
  z
    .object({
      create: z
        .union([
...
export const ExerciseUncheckedCreateNestedManyWithoutTagsInputObjectSchema =
  Schema;
