...
const Schema: z.ZodType<Prisma.CustomerPaymentUpdateOneWithoutCustomerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CustomerPaymentUpdateOneWithoutCustomerNestedInputObjectSchema =
  Schema;
