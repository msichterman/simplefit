...
const Schema: z.ZodType<Prisma.WorkoutUncheckedUpdateManyWithoutSavedByNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => WorkoutUpdateManyWithWhereWithoutSavedByInputObjectSchema
          ),
          z
            .lazy(
              () => WorkoutUpdateManyWithWhereWithoutSavedByInputObjectSchema
...
export const WorkoutUncheckedUpdateManyWithoutSavedByNestedInputObjectSchema =
  Schema;
