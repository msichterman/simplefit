...
const Schema: z.ZodType<Prisma.WorkoutUpdateManyWithoutAuthorNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => WorkoutUpdateManyWithWhereWithoutAuthorInputObjectSchema),
        z
          .lazy(() => WorkoutUpdateManyWithWhereWithoutAuthorInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const WorkoutUpdateManyWithoutAuthorNestedInputObjectSchema = Schema;
