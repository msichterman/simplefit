...
const Schema: z.ZodType<Prisma.WorkoutUpdateManyWithWhereWithoutExercisesInput> =
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(
          () => WorkoutUncheckedUpdateManyWithoutWorkoutsInputObjectSchema
        ),
      ]),
    })
    .strict();

export const WorkoutUpdateManyWithWhereWithoutExercisesInputObjectSchema =
  Schema;
