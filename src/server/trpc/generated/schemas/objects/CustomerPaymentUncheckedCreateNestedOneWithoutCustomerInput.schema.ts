...
const Schema: z.ZodType<Prisma.CustomerPaymentUncheckedCreateNestedOneWithoutCustomerInput> =
  z
    .object({
      create: z
        .union([
...
export const CustomerPaymentUncheckedCreateNestedOneWithoutCustomerInputObjectSchema =
  Schema;
