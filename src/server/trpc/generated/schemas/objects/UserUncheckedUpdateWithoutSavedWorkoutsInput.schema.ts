...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutSavedWorkoutsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const UserUncheckedUpdateWithoutSavedWorkoutsInputObjectSchema = Schema;
