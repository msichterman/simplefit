...
const Terms: NextPage = () => {
  return (
    <PageLayout>
      <Head>
        <title>Simple Fit – Terms of Service</title>
        <meta name="description" content="Simple Fit's Privacy Policy" />
            ...
            <div className="relative px-4 sm:px-6 lg:px-8">
              ...
              <div className="prose-base prose-neutral prose mx-auto mt-6 dark:prose-invert">
                <p>
                  ...
                  <a href="https://simplefit.ai/legal/privacy-policy">
                    https://simplefit.ai/legal/privacy-policy
                  </a>
                  , constitutes a legally binding agreement made between you,
                  whether personally or on behalf of an entity (“user” or “you”)
                  and Simple Fit and its affiliated companies, Websites,
                  applications and tools (collectively, Simple Fit, “Company” or
                  “we” or “us” or “our”), concerning your access to and use of
                  the <a href="https://simplefit.ai">https://simplefit.ai</a>{" "}
                ...
                <p>
                  Simple Fit may offer free trial or sample of our products or
                  ...
                  first. Simple Fit will bill you through a payment provider for
                  our Services. By using our paid options you agree to pay
                  Simple Fit all charges at the prices then in effect for the
                  products or services you or other persons using your billing
                  account may purchase, and you authorize Simple Fit to charge
                  ...
                  the applicable product or service. Simple Fit reserves the
                ...
                <p>
                  By using the Simple Fit Services, you represent and warrant
                  that:
                </p>
                <ol>
                  <li>
                ...
                <p>
                  ...
                  Simple Fit will be treated as non-confidential and
                ...
                <ol>
                  ...
                  <li>
                    ...
                    and to authorize Simple Fit and the Sites&#39; users to use
                    your Contributions as necessary to exercise the licenses
                  ...
                  <li>
                    ...
                    by Simple Fit), libelous or slanderous, does not ridicule,
                ...
                <p>
                  Simple Fit may accept, reject or remove reviews in its sole
                  discretion. Simple Fit has absolutely no obligation to screen
                  reviews or to delete reviews, even if anyone considers reviews
                  objectionable or inaccurate. Those persons posting reviews
                  should comply with the following criteria: (1) reviewers
                  should have firsthand experience with the person/entity being
                  reviewed; (2) reviews should not contain: offensive language,
                  profanity, or abusive, racist, or hate language;
                  discriminatory references based on religion, race, gender,
                  national origin, age, marital status, sexual orientation or
                  disability; or references to illegal activity; (3) reviewers
                  should not be affiliated with competitors if posting negative
                  reviews; (4) reviewers should not make any conclusions as to
                  the legality of conduct; and (5) reviewers may not post any
                  false statements or organize a campaign encouraging others to
                  post reviews, whether positive or negative. Reviews are not
                  endorsed by Simple Fit, and do not represent the views of
                  Simple Fit or of any affiliate or partner of Company. Simple
                  Fit does not assume liability for any review or for any
                  claims, liabilities or losses resulting from any review. By
                  posting a review, the reviewer hereby grants to Simple Fit a
                  perpetual, non-exclusive, worldwide, royalty-free, fully-paid,
                  assignable and sublicensable license to Simple Fit to
                ...
                <p>
                  ...
                  information through the Sites; or (ii) allowing Simple Fit to
                  ...
                  Forestry and/or grant Simple Fit access to your Third Party
                  ...
                  Forestry to pay any fees or making Simple Fit subject to any
                  usage limitations imposed by such third party service
                  providers. By granting Simple Fit access to any Third Party
                  Accounts, you understand that (i) Simple Fit may access, make
                  ...
                  limitation any friend lists, and (ii) Simple Fit may submit
                  ...
                  becomes unavailable or Simple Fit access to such Third Party
                  ...
                  WITH SUCH THIRD PARTY SERVICE PROVIDERS. Simple Fit makes no
                  effort to review any Social Network Content for any purpose,
                  including but not limited to, for accuracy, legality or
                  non-infringement, and Simple Fit is not responsible for any
                  ...
                  settings (if applicable), Simple Fit will deactivate the
                  connection between the Sites and your Third Party Account and
                  delete any information stored on Simple Fit servers that was
                ...
                <p>
                  ...
                  Sites or the Simple Fit Services (&quot;Submissions&quot;)
                  provided by you to Simple Fit are non-confidential and Web
                ...
                <p>
                  ...
                  other than that for which Simple Fit makes it available. The
                  Sites may not be used in connection with any commercial
                  endeavors except those that are specifically endorsed or
                  approved by Simple Fit. Prohibited activity includes, but is
                  not limited to:
                </p>
                <ol>
                  <li>
                ...
                <p>
                  The content on the Sites (“Simple Fit Content”) and the
                  trademarks, service marks and logos contained therein
                  (“Marks”) are owned by or licensed to Simple Fit, and are
                  subject to copyright and other intellectual property rights
                  under United States and foreign laws and international
                  conventions. Simple Fit Content, includes, without limitation,
                  all source code, databases, functionality, software,
                  Sites&#39; designs, audio, video, text, photographs and
                  graphics. All Simple Fit graphics, logos, designs, page
                  headers, button icons, scripts and service names are
                  registered trademarks, common law trademarks or trade dress of
                  Simple Fit in the United States and/or other countries. Web
                  ...
                  permission of the Simple Fit.
                </p>
                <p>
                  Simple Fit Content on the Sites is provided to you “AS IS” for
                  ...
                  consent of the respective owners. Provided that you are
                  eligible to use the Sites, you are granted a limited license
                  to access and use the Sites and the Web Forestry Content and
                  to download or print a copy of any portion of the Simple Fit
                  Content to which you have properly gained access solely for
                  your personal, non-commercial use. Simple Fit reserves all
                  rights not expressly granted to you in and to the Sites and
                  Simple Fit Content and Marks.
                </p>
                ...
                <p>
                  ...
                  the Simple Fit Services) links to other websites (&quot;Third
                  ...
                  not responsible for any Third Party accessed through the Sites
                  or any Third Party Content posted on, available through or
                  installed from the Sites, including the content, accuracy,
                  ...
                  endorsement thereof by us. If you decide to leave the Sites
                  ...
                  be aware that our terms and policies no longer govern. You
                  should review the applicable terms and policies, including
                  privacy and data gathering practices, of any websites to which
                  you navigate from the Sites or relating to any applications
                  you use or install from the Sites. Any purchases you make
                  through Third Party Websites will be through other websites
                  and from other companies, and Web Forestry takes no
                ...
                <p>
                  Simple Fit reserves the right but does not have the obligation
                  to:
                </p>
                <ol>
                  ...
                  <li>
                    in Simple Fit sole discretion and without limitation,
                    ...
                    Agreement or any Simple Fit policy;
                  </li>
                  <li>
                    ...
                    any way burdensome to Simple Fit &#39;s systems;
                  </li>
                  <li>
                    otherwise manage the Sites in a manner designed to protect
                    the rights and property of Simple Fit and others and to
