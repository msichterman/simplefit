...
const AuthLayout = ({ children }: AuthLayoutProps) => {
  ...
  switch (status) {
    ...
    default:
      return (
        <div className="flex h-screen max-h-full min-h-screen  w-full min-w-full flex-col justify-between bg-zinc-50 dark:bg-neutral-900 dark:text-zinc-50">
          <div className="mx-auto flex h-full max-h-full w-full justify-center md:px-12 lg:px-0">
            ...
            <div className="hidden h-full w-full bg-radial-at-br from-amber-400 via-zinc-300 to-amber-600 lg:block" />
          </div>
          <Footer isTight />
        </div>
      );
