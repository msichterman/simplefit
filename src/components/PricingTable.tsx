      ...
      <div className="relative overflow-hidden pt-32 pb-96 lg:pt-40">
        <div className="relative mx-auto max-w-7xl px-6 text-center lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-4xl">
            ...
            <HTwo className="mt-2 text-3xl font-bold tracking-tight text-zinc-50 sm:text-4xl lg:text-5xl">
                    ...
                    <div className="flex flex-1 flex-col justify-between rounded-3xl bg-zinc-50 p-6 dark:bg-neutral-700/30 sm:p-8">
                      ...
                      <div className="mt-8">
                        <button
                          ...
                          className="inline-block w-full rounded-lg bg-amber-600 px-4 py-2.5 text-center text-sm font-semibold leading-5 text-zinc-50 shadow-md hover:bg-amber-700"
